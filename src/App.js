...
{photo: <img style={{width:'80%',height:'80%'}} src={d2} alt="logo" />,cnt:0,id:'12', photo1: <img style={{width:'80%'}} src={d2} alt="logo" />,name:'D2',price:120,color:'ירוק כהה,אפור,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={d3} alt="logo" />,cnt:0,id:'13', photo1: <img style={{width:'80%'}} src={d3s} alt="logo" />,name:'D3',price:120,color:'ורוד,לבן,צהוב,שחור'},
{photo: <img style={{width:'80%',height:'80%'}} src={d4} alt="logo" />,cnt:0,id:'14', photo1: <img style={{width:'80%'}} src={d4s} alt="logo" />,name:'D4',price:120,color:'ירוק,לבן'},
...
{photo: <img style={{width:'80%',height:'80%'}} src={y3} alt="logo" />,cnt:0,id:'22', photo1: <img style={{width:'80%'}} src={y3s} alt="logo" />,name:'Y3',price:100,color:'לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y2} alt="logo" />,cnt:0,id:'23', photo1: <img style={{width:'80%'}} src={y2s} alt="logo" />,name:'Y2',price:120,color:'שחור,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y4} alt="logo" />,cnt:0,id:'24', photo1: <img style={{width:'80%'}} src={y4} alt="logo" />,name:'Y4',price:130,color:'ירוק,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y5} alt="logo" />,cnt:0,id:'25', photo1: <img style={{width:'80%'}} src={y5} alt="logo" />,name:'Y5',price:120,color:'ורוד,צהוב,לבן,אפור'},
{photo: <img style={{width:'80%',height:'80%'}} src={y6} alt="logo" />,cnt:0,id:'26', photo1: <img style={{width:'80%'}} src={y6s} alt="logo" />,name:'Y6',price:120,color:'כחול,תכלת,חום,אדום,אפור,לבן,שחור'},
{photo: <img style={{width:'80%',height:'80%'}} src={y7} alt="logo" />,cnt:0,id:'27', photo1: <img style={{width:'80%'}} src={y7} alt="logo" />,name:'Y7',price:120,color:'ירוק,לבן,שחור'},
{photo: <img style={{width:'80%',height:'80%'}} src={y8} alt="logo" />,cnt:0,id:'28', photo1: <img style={{width:'80%'}} src={y8} alt="logo" />,name:'Y8',price:120,color:'סגול,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y9} alt="logo" />,cnt:0,id:'29', photo1: <img style={{width:'80%'}} src={y9s} alt="logo" />,name:'Y9',price:120,color:'ירוק'},
{photo: <img style={{width:'80%',height:'80%'}} src={y10} alt="logo" />,cnt:0,id:'30', photo1: <img style={{width:'80%'}} src={y10} alt="logo" />,name:'Y10',price:120,color:'אפור,חום,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y11} alt="logo" />,cnt:0,id:'31', photo1: <img style={{width:'80%'}} src={y11} alt="logo" />,name:'Y11',price:130,color:'ירוק זית,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y12} alt="logo" />,cnt:0,id:'32', photo1: <img style={{width:'80%'}} src={y12s} alt="logo" />,name:'Y12',price:120,color:'ירוק,ורוד,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y13} alt="logo" />,cnt:0,id:'33', photo1: <img style={{width:'80%'}} src={y13} alt="logo" />,name:'Y13',price:120,color:'ירוק,שחור,לבן'},
{photo: <img style={{width:'80%',height:'80%'}} src={y14} alt="logo" />,cnt:0,id:'34', photo1: <img style={{width:'80%'}} src={y14} alt="logo" />,name:'Y14',price:120,color:'חום,שחור,אדום,לבן'},
])
